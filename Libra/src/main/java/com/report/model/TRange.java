...
class TRange extends ArrayList<Row> {
    ...
    void paint(DataSet set, boolean useFullSet) {
    ...
    public Object getValue(String name, DataSet set, int nr) {
    ...
    private void createNewRow(Row rowOld, DataSet set, int nr) {
    ...
    void addMergedRange(Sheet oldSheet) {
    ...
    private void setMerge(int startRow) {
    ...
    private void initCell(Cell cOld, Cell cNew, DataSet set, int nr) {
    ...
    private Object parseContent(String content, DataSet set, int nr) {
        char LF = '\uFFFF';
    ...
    private boolean isNeedLetter(char ch) {
        return ch == '_' || Character.isLetterOrDigit(ch);
    }

    private String copyFormula(Cell oldCell, Cell newCell, String oldFormula) {
