package com.orders.report.bin;

import com.dao.model.DataSet;
import com.orders.report.model.TBand;
...
public class ReportGear {
    ...
    public void make(File source, DataSet header, DataSet master) throws Exception {
        File file = createReport(source, header, master);
        Desktop.getDesktop().open(file);
    }

    public File createReport(File source, DataSet header, DataSet master) throws Exception {
        this.header = header;
        this.master = master;
