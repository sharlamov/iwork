...
public enum InsertType {
    ...
    UNIVOF("declare\n" +
            ...
            "  insert into tms_munc(cod, pasaport, orgeloberat, dataelibpas)values(vcod, :seria, :orgelib, :dataelib) returning cod into ?;  \n" +
            " end;"),
    UNIVTA( "declare\n" +
            " vcod number;\n" +
            "begin\n" +
    ...
    UNIVCELL("{call insert into vms_univers (cod, denumirea, tip, gr1) values (id_tms_univers.nextval, :clccodt, :tip, :gr1) RETURNING cod INTO ? }");
