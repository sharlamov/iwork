...
public class JFontChooser extends JComponent {
    ...
    private void init(Font font) {
        ...
        fontList.setSelectedValue(font != null ? font.getName(): previewLabel.getFont().getName(), true);
        sizeList.setSelectedValue(font != null ? font.getSize(): previewLabel.getFont().getSize(), true);
        boldCheckBox.setSelected(font != null ? font.isBold(): previewLabel.getFont().isBold());
        italicCheckBox.setSelected(font != null ? font.isItalic(): previewLabel.getFont().isItalic());
    }
...
class DefaultFontSelectionModel implements FontSelectionModel {
    ...
    public static final Font DEFAULT_INITIAL_FONT = new Font("Dialog", Font.PLAIN, 12);
